...
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "/home/rstudio/DADA2/silva_nr99_v138.2_toGenus_trainset.fa.gz.3", multithread=TRUE)
```

```{r}
taxa <- addSpecies(taxa, "/home/rstudio/DADA2/silva_v138.2_assignSpecies.fa.gz")
```
